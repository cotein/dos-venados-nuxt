    ...
    <section class="realtive md:py-24 py-16" id="services">
        <div class="container relative">
            <div class="grid grid-cols-1 pb-6 text-center">
                <h3 class="font-semibold text-2xl leading-normal mb-4">Videos de nuestro complejo</h3>
                ...
                <div class="lg:col-span-8 md:col-span-7">
                    <div id="myTabContent" class="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                        ...
                        <div :class="activeindex !== '1' ? 'hidden' : '' " role="tabpanel" aria-labelledby="profile-tab" >
                            ...
                            <video src="/assets/videos/cbs2.mp4" width="840" height="480" loop controls
                            poster="/assets/videos/cbs2.png"></video>
                            <!-- <div class="mt-6">
                        ...
                        <div :class="activeindex !== '2' ? 'hidden' : '' " id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                            <video src="/assets/videos/cbs3.mp4" width="840" height="480" loop controls
                            poster="/assets/videos/cbs3.png"></video>
                        ...
                        <div :class="activeindex !== '3' ? 'hidden' : '' " id="settings" role="tabpanel" aria-labelledby="settings-tab">
                            <video src="/assets/videos/cbs1.mp4" width="840" height="480" loop controls
                            poster="/assets/videos/cbs1.png"></video>
